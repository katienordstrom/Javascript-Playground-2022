...
// /* Diff between (=) and (===)
// single = asigns value to a variable. 
// triple = used in conditional statements. When comparing two values. 
// */

// /* Statements vs Expressions
// Statements is doing things. eg var numbers
// Expressions produce values. eg var new_value = function sum (x1, x2)
// */
...
// //This is an Expression ES6
// // var x = y >= 0 ? y : y

// var word = "jhdiokling"
// console.log(word.length)

// //JavaScript Values (primitive vs objects)
...
//These are primitave values in JS
//Boolean: true and false
//Numbers: 1234, 123.4
//Strings: 'hdbsjhdj' or "jhshvjvs" either quotations is correct
